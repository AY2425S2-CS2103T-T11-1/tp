...
import static seedu.address.logic.parser.CommandParserTestUtil.assertParseable;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        Person expectedPersonMultipleTags =
                new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                        .build();
        assertParseSuccess(parser,
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        assertParseFailure(parser,
                validExpectedPersonString + PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY
                        + YEAR_DESC_AMY + MAJOR_DESC_AMY + HOUSING_DESC_AMY
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser,
                NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + YEAR_DESC_AMY + MAJOR_DESC_AMY
                        + HOUSING_DESC_AMY + LINK_DESC_AMY,
                new AddCommand(expectedPerson));

        assertParseable(parser, NAME_DESC_BOB + EMAIL_DESC_BOB
                + YEAR_DESC_BOB + MAJOR_DESC_BOB + HOUSING_DESC_BOB);

        assertParseable(parser, NAME_DESC_BOB + PHONE_DESC_BOB
                + YEAR_DESC_BOB + MAJOR_DESC_BOB + HOUSING_DESC_BOB);

        assertParseable(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + MAJOR_DESC_BOB + HOUSING_DESC_BOB);

        assertParseable(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + YEAR_DESC_BOB + HOUSING_DESC_BOB);

        assertParseable(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + YEAR_DESC_BOB + MAJOR_DESC_BOB);
