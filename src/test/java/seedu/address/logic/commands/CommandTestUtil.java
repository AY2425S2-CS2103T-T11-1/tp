...
public class CommandTestUtil {
    ...
    public static final String VALID_HOUSING_AMY = "Block 312, Amy Street 1";
    public static final String VALID_HOUSING_BOB = "Block 123, Bobby Street 3";
    public static final String VALID_TAG_HUSBAND = "husband";
    public static final String VALID_TAG_FRIEND = "friend";
    public static final String VALID_LINK_AMY = "https://nusmods.com/timetable/sem-2/share?"
            + "ACC1701X=TUT:X06,LEC:X2&CS2101=&CS2103T=LEC:G12&CS2109S=TUT:34,LEC:1&ST2334=LEC:1,TUT:4";
    public static final String VALID_LINK_BOB = "https://nusmods.com/timetable/sem-2/share?"
            + "CS2101=&CS2109S=TUT:34,LEC:1&ST2334=LEC:1,TUT:4";
    ...
    public static final String INVALID_YEAR_DESC = " " + PREFIX_YEAR + "7"; // must be between 1-6
    public static final String INVALID_MAJOR_DESC = " " + PREFIX_MAJOR; // empty string not allowed for majors
    public static final String INVALID_HOUSING_DESC = " " + PREFIX_HOUSING; // empty string not allowed for housing
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withMajor(VALID_MAJOR_AMY).withHousing(VALID_HOUSING_AMY).withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withYear(VALID_YEAR_AMY)
                .withMajor(VALID_MAJOR_BOB).withHousing(VALID_HOUSING_BOB)
